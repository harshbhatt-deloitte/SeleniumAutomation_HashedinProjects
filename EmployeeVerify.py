...
class Login(unittest.TestCase):
    ...
    def test_verify(self):
        ...
        assert self.driver.find_element(By.XPATH, "//a[@href='/admin/users']").is_displayed()
        assert self.driver.find_element(By.XPATH, "//a[@href='/admin/users']").is_enabled()
        self.driver.find_element(By.XPATH, "//a[@href='/admin/users']").click()
        self.driver.implicitly_wait(5)
